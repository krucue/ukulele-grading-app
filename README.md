...
เบราว์เซอร์จะเปิดขึ้นมาเอง แล้วใช้งานทั้งหมดในหน้าเว็บ: กรอกชื่อนักเรียน → ลากรูป 2 หน้ามาวาง
→ กดตรวจ → แก้คะแนนข้อที่ระบบไม่มั่นใจ → กดบันทึก
...
│   ├── templates/index.html   # หน้าจอเดียวจบ: กรอกชื่อ -> ลากรูป -> ตรวจ -> แก้คะแนน -> บันทึก
...
|---|---|
| ถ่าย/สแกนภาพ | ยังไม่ได้เขียน (ฝั่งแอปมือถือ/กล้อง — นอก scope โค้ด backend นี้) ระหว่างนี้ครูถ่ายด้วยมือถือแล้วอัปโหลดผ่านเว็บแอปได้ |
